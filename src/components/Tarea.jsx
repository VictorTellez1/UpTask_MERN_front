import { formatearFecha } from "../helpers/formartearFecha"
  ...
  return (
    <div className="border-b p-5 flex justify-between items-center">
        <div className="flex flex-col items-start">
            <p className="mt-2 text-xl">{nombre}</p>
            <p className="mt-2 text-sm text-gray-500 uppercase">{descripcion}</p>
            <p className="mt-2 text-sm">{formatearFecha(fechaEntrega)}</p>
            <p className="mt-2 text-xl text-gray-600">Prioridad: {prioridad}</p>
