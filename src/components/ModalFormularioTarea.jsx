                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase text-sm' htmlFor='nombre'>
                                                Nombre Tarea
                                            </label>
                                            <input
                                                type="text"
                                        ...
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase text-sm' htmlFor='descripcion'>
                                                Descripcion Tarea
                                            </label>
                                            <textarea
                                                id="descripcion"
                                        ...
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase text-sm' htmlFor='fecha'>
                                                Fecha Entrega
                                            </label>
                                            <input
                                                type="date"
                                        ...
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase text-sm' htmlFor='prioridad'>
                                                Prioridad Tarea
                                            </label>
                                            <select
                                                id="prioridad"
