...
import ColaboradorFormulario from "../components/ColaboradorFormulario"
          ...
          <div className='flex justify-center mt-10'>
            <div className='bg-white py-10 px-5 w-full md:w-1/2 rounded-lg shadow'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <button
                  type="button"
                  className='bg-slate-500 px-5 py-2 w-full rounded-lg uppercase text-white font-bold text-sm'
